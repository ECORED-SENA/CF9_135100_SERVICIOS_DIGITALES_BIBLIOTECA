  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Estrategias de atención en medios tecnológicos
      ...
      .col-lg-10
        .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5
          ...
          .bloque-texto-g__texto.p-4
            p.mb-0 La construcción del término <span style="color:#785549">#[b necesidades de información]</span> es una elaboración abstracta, un término genérico, generalmente usado para responder por qué las personas buscan, demandan, encuentran y usan la información.
          ...
          SlyderA(tipo="b")
            .row.justify-content-center.align-items-center
              .col-lg-7.order-lg-1.order-2
                .h4 Inquietud de los individuos
                p.mb-0 Hay que considerar que la búsqueda, demanda o deseo de información es la evidencia de que existe una necesidad saber algo más que lo inquieta o preocupa respecto a los demás individuos.
              .col-lg-4.col-8.order-lg-2.order-1.mb-lg-0.mb-4
                img(src='@/assets/curso/tema3/img05.jpg')
            .row.justify-content-center.align-items-center
              .col-lg-7.order-lg-1.order-2
                .h4 Necesidad en varias dimensiones
                p.mb-0 Las necesidades de información se presentan en todos los aspectos de la vida diaria: en el hogar, en la oficina, en las relaciones familiares, en la vida social, etc.
              .col-lg-4.col-8.order-lg-2.order-1.mb-lg-0.mb-4
                img(src='@/assets/curso/tema3/img06.jpg')
            .row.justify-content-center.align-items-center
              .col-lg-7.order-lg-1.order-2
                .h4 La curiosidad y la capacidad del asombro
                p.mb-0 Las necesidades de información se presentan, en la mayoría de los casos, por curiosidad; sin embargo, no solo las personas presentan una necesidad de información: también las organizaciones o instituciones, pero no hay que olvidar que dichas entidades están compuestas por personas.
              .col-lg-4.col-8.order-lg-2.order-1.mb-lg-0.mb-4
                img(src='@/assets/curso/tema3/img07.jpg')
            .row.justify-content-center.align-items-center
              .col-lg-7.order-lg-1.order-2
                .h4 Impulso colectivo y social
                p.mb-0 “Así como la necesidad de información y conocimiento impulsa al individuo, también impulsa a la sociedad misma. Si esta última quiere evitar la decadencia, debe tomar constantes medidas preventivas para la identificación y adquisición de nueva información que le permita robustecer sus necesidades y actividades administrativas” (Valery y Brush, 1988).
              .col-lg-4.col-8.order-lg-2.order-1.mb-lg-0.mb-4
      ...
      .col-lg-8.col-11.BG08.p-4
        .row.align-items-center
          ...
          .col
            ...
            p.mb-0 La biblioteca es la institución que ha creado el ser humano para preservar, organizar y difundir la información sin importar el material en que se encuentre registrada y la sociedad espera obtener la información que necesita de ella.

    separador
    #t_3_2.titulo-segundo.color-acento-contenido(data-aos="fade-right")
      h2 3.2 Segmentación de usuarios y necesidades

    p La segmentación de usuarios respecto a las necesidades de información corresponde a <span style="color:#785549">#[b dividir un público objetivo de un producto o servicio]</span> en partes más pequeñas, respecto a sus expectativas y preferencias. 

    .row.justify-content-center.align-items-center.mb-4
      .col-lg-5.col-10.mb-lg-0.mb-4
        img(src="@/assets/curso/tema3/img09.png")
      .col-lg-5
        p Las etapas del proceso de segmentación de usuarios, son:
        ul.lista-ul--color
          li
          ...
          li
            <i class="fas fa-circle" style="color:#FD9827; font-size: x-small"></i>
            p #[b Elección de un posicionamiento]: en cada uno de los segmentos objetivo considerados, se debe posicionar sobre la base de las expectativas de los usuarios.  

    p En el siguiente esquema se presentan los elementos, aspectos y generalidades de la segmentación de usuarios de bibliotecas, a saber:
    ...
    .row.justify-content-center.mb-4
      .col-lg-10.BGR01.p-4
        .row.justify-content-center.align-items-center.mb-4
          ...
          .col-lg-8
            p Al respecto del servicio al cliente como estrategia efectiva de atención, es importante tener presente que:
            ul.lista-ul--color
              li
                <i class="fas fa-circle" style="color:#FD9827; font-size: x-small"></i>
                | La presencia y dinámica de los servicios de información de la biblioteca en internet es cada vez mayor. 
              li
                <i class="fas fa-circle" style="color:#FD9827; font-size: x-small"></i>
                | Esto debe considerarse también en la política de gestión bibliotecaria dirigida a la captación y fidelización de los clientes.
              li
                <i class="fas fa-circle" style="color:#FD9827; font-size: x-small"></i>
                | Algunos estudios han demostrado que un usuario satisfecho hablará de su experiencia positiva con dos o tres personas más sobre su satisfacción.
              li
                <i class="fas fa-circle" style="color:#FD9827; font-size: x-small"></i>
                | Por otro lado, un usuario insatisfecho hablará con más de diez personas sobre su insatisfacción.
              li
                <i class="fas fa-circle" style="color:#FD9827; font-size: x-small"></i>
                | Se necesita saber orientar y satisfacer, convenientemente, las necesidades informativas de cada usuario o grupo de usuarios, desde los servicios bibliotecarios. 
    ...
    .BGIMG10.px-md-5.px-4
      ...
      .row.justify-content-center.mb-4
        .col-lg-10.mb-4
          .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5
            .bloque-texto-g__img(
              :style="{'background-image': `url(${require('@/assets/curso/tema3/img17.jpg')})`}"
            )
            .bloque-texto-g__texto.p-4
              p.mb-0 La biblioteca también ha hecho uso de estas herramientas para darse a conocer y promocionar sus servicios. También se puede confeccionar un CD o DVD, con toda la información de la biblioteca y, de esta manera, promocionarse.
        .col-lg-10
          .row.align-items-center.BGR02
            .col-lg-1.col-2.px-0
              img.img-w90(src="@/assets/curso/temas/img04.png")
            .col.p-4
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
    ...
    p La organización temática de los recursos de la información o colecciones bibliográficas, en la actualidad, se desarrolla mediante procesos manuales, automatizados o híbridos.
    p La indización o estructuración de índices, que no es otra cosa que dar orden consecuente a la información o material, se fundamenta en la tarea experta del indizador o catalogador quien aplica un proceso de análisis documental y, a través de la consulta de lenguajes de indización (tesauros, taxonomías, encabezamientos de materias, catalogación, etc.), concreta en signos lingüísticos de qué tratan los recursos.  
    p Sobre la indización, tenga en cuenta que:
